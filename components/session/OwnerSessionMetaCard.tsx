    ...
    >
      ...
      >
        ...
        <Text style={{ color: theme.onPrimary, fontFamily: SCREEN_FONTS.label, fontSize: 11, opacity: 0.8 }}>
          {isRanked ? 'Tính điểm Elo' : 'Không xếp hạng'}
        </Text>
      </View>
        ...
        <View style={{ gap: 12 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 16 }}>
            <View style={{ flex: 1, backgroundColor: theme.surfaceContainerLow, padding: 12, borderRadius: RADIUS.md }}>
              <Text style={{ color: theme.outline, fontFamily: SCREEN_FONTS.label, fontSize: 9, textTransform: 'uppercase', marginBottom: 2 }}>KẾT QUẢ</Text>
              <Text style={{ color: theme.onSurface, fontFamily: SCREEN_FONTS.headline, fontSize: 14 }}>
                {requireResults ? 'Bắt buộc nhập' : 'Tùy chọn'}
              </Text>
            </View>
            <View style={{ flex: 1, backgroundColor: theme.surfaceContainerLow, padding: 12, borderRadius: RADIUS.md }}>
              <Text style={{ color: theme.outline, fontFamily: SCREEN_FONTS.label, fontSize: 9, textTransform: 'uppercase', marginBottom: 2 }}>QUY MÔ</Text>
              <Text style={{ color: theme.onSurface, fontFamily: SCREEN_FONTS.headline, fontSize: 14 }}>
                {maxPlayers} Người chơi
              </Text>
            </View>
          </View>
        </View>
