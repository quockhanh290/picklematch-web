...
export function HostCreateSessionStep2({
  onBack,
  maxPlayers,
  setMaxPlayers,
  minSkill,
        ...
        <View style={{ borderRadius: RADIUS.xl, borderWidth: BORDER.base, borderColor: theme.outlineVariant, backgroundColor: theme.surfaceContainerLow, padding: SPACING.lg, marginBottom: 16 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flex: 1, paddingRight: 12 }}>
              ...
              <Text style={{ fontFamily: SCREEN_FONTS.body, fontSize: 12, color: theme.onSecondaryContainer, marginTop: 2 }}>{'Host cần duyệt người tham gia'}</Text>
            </View>
            <Switch
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flex: 1, paddingRight: 12 }}>
              <Text style={{ fontFamily: SCREEN_FONTS.headline, fontSize: 16, color: theme.primary }}>{'Host cùng tham gia'}</Text>
              <Text style={{ fontFamily: SCREEN_FONTS.body, fontSize: 12, color: theme.onSecondaryContainer, marginTop: 2 }}>{'Tên Host sẽ hiện trong danh sách người chơi'}</Text>
            </View>
            <Switch
              value={hostIsPlaying}
