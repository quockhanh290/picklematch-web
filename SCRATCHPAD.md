...
- **NO_VALID_MATCH giả khi deadline hết** · PLAUSIBLE (chưa repro) · `suggest.ts:839-846`: hai chốt rescue (712, 800) đều guard thời gian; nếu regular ăn hết budget thì bị skip → trả NO_VALID_MATCH dù stage-8 còn nghiệm. Path live che bởi rescue tầng ngoài; API trần (sim/session-rounds-suggest) là false-negative tiềm ẩn.
