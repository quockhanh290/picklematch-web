...
import { View, Text, TouchableOpacity, ScrollView, LayoutAnimation, Platform, Alert, Image, Dimensions } from 'react-native'
...
export function OwnerMatchScreen({ sessionId, matches, players, onUpdated }: Omit<Props, 'onClose'>) {
