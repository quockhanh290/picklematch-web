-- EMERGENCY ROLLBACK for 20260722000004_fix_suggestion_round_no_straggler_pin.sql
-- Restores the ORIGINAL replace_live_session_suggestions_versioned (min-live-round scheme)
-- from 20260703000007. Paste into SQL Editor to revert. Safe: create-or-replace, no data change.
