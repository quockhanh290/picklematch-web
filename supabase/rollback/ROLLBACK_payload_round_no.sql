-- EMERGENCY ROLLBACK for 20260722000006_unify_payload_start_round_no_per_court.sql
-- Restores the floor(seq/expected) round_no scheme (state as of 20260722000003).
