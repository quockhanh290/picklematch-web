-- EMERGENCY ROLLBACK for 20260722000005_cancel_runs_round_completion_rest.sql
-- Restores cancel WITHOUT the round-completion rest bookkeeping (state as of 20260722000002).
-- Paste into SQL Editor to revert. Safe: create-or-replace, no data change.
