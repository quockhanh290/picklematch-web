-- Migration: Update get_my_sessions_overview to include total_cost
-- Created: 2026-05-10
...
as $$
  ...
  host_sessions as (
    select
      ...
      s.elo_min,
      s.elo_max,
      coalesce(s.total_cost, (os.format_metadata->>'cost_per_person')::integer, os.total_cost, 0)::integer as total_cost,
      os.format_type
