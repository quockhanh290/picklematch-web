-- Update get_session_detail_overview to include owner-specific metadata
...
begin
  ...
  with base_session as (
    select
      ...
      s.elo_skip_reason,
      s.is_owner_managed,
      -- JOIN with owner_sessions
      os.format_type as owner_format,
      os.sub_court_numbers,
      os.is_unlimited,
      os.format_metadata
    from public.sessions s
    left join public.owner_sessions os on os.id = s.id
  ...
  select jsonb_build_object(
    ...
    (
      select jsonb_build_object(
        ...
        'is_owner_managed', s.is_owner_managed,
        -- New Owner Fields
        'owner_format', s.owner_format,
        'sub_court_numbers', s.sub_court_numbers,
        'is_unlimited', s.is_unlimited,
        'format_metadata', s.format_metadata,
