-- Treat opt-rest as a one-round request in live match mode.
-- When all matches in a logical round are completed, any present player who
-- did not play that round is counted as resting and their opt-rest flag clears.
