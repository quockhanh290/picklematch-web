-- Allow starting remaining previews from the same generated batch after sibling
-- previews have already been started. A preview is still stale after any live
-- completion/cancel or any non-start mutation that advances the version without
-- adding live matches.
